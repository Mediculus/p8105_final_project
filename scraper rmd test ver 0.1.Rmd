...
# Scraper test PubMed
Attempting to scrape PubMed results for our relevant issues quickly comes to a halt because we noticed that as we try to search results, their html does **NOT** change or provide a page number. We quickly scraped this from our tries. 
...
outcome_measure <- 
  read_html("https://clinicaltrials.gov/ct2/show/results/NCT00195702") %>% 
  html_nodes("#EXPAND-outcome-data-1 .labelSubtle") %>% 
  html_text()



# a yes-no test to either one which signals to scrape or skip.
